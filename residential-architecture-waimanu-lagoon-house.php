...
<head>
	...
	<meta charset="utf-8" />
	<title>WAIMANU LAGOON HOUSE | Space Architecture</title>
...
<body class="black">
	<div id="container-gallery">
		...
		<h2 class="gallery-heading"> WAIMANU LAGOON HOUSE </h2>
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/waikanae3/eade1.jpg" class="init-hidden" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>
	
			<section class="vertical-gallery">
				<img src="images/waikanae3/eade2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae3/eade3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae3/eade4.jpg" class="picture2 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae3/eade5.jpg" class="picture3 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae3/eade6.jpg" class="picture2 init-hidden" id="6-slide" rel="up" />
				<p id="6-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae3/eade7.jpg" class="picture3 init-hidden" id="7-slide" rel="right" />
				<p id="7-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae3/eade8.jpg" class="picture2 init-hidden" id="8-slide" rel="up" />
