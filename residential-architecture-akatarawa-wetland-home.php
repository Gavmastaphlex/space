...
<head>
	...
	<script type="text/javascript">
		...
		$(['images/aka/aka1.2.jpg','images/aka/aka2.jpg','images/aka/aka3.jpg']).preload();
	...
	<div id="container-gallery">
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/aka/aka1.jpg" style="display:none" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/aka/aka2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/aka/aka3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/aka/aka4.jpg" class="picture2 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text  text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/aka/aka5.jpg" class="picture2 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/aka/aka6.jpg" class="picture4 init-hidden" id="6-slide" rel="up" />
				<p id="6-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>
			
			<section class="horizontal-gallery">
				<img src="images/aka/aka7.jpg" class="picture3 init-hidden" id="7-slide" rel="right" />
				<p id="7-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/aka/aka8.jpg" class="picture4 init-hidden" id="8-slide" rel="up" />
			...
			<section class="horizontal-gallery">
				<img src="images/aka/aka9.jpg" class="picture3 init-hidden" id="9-slide" rel="right" />
			...
			<section class="vertical-gallery">
				<img src="images/aka/aka10.jpg" class="picture4 init-hidden" id="10-slide" rel="up" />
				<p id="10-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/aka/aka11.jpg" class="picture3 init-hidden" id="11-slide" rel="right" />
				<p id="11-text" class="horizontal-gallery-text init-hidden"></p>
			</section>
