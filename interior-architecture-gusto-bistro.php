...
<head>
	...
	<meta charset="utf-8" />	
	<title>GUSTO BISTRO | Space Architecture</title>
...
<body class="black">
	...
	<div id="container-gallery">
		...
		<h2 class="gallery-heading"> GUSTO BISTRO </h2>
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/gusto-bistro/gusto1.jpg" style="display:none" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/gusto-bistro/gusto2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/gusto-bistro/gusto3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/gusto-bistro/gusto4.jpg" class="picture2 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/gusto-bistro/gusto5.jpg" class="picture2 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/gusto-bistro/gusto6.jpg" class="picture6 init-hidden" id="6-slide" rel="up" />
