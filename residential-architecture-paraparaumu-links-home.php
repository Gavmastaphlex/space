...
<head>
	...
	<meta charset="utf-8" />
	<title>PARAPARAUMU LINKS HOME | Space Architecture</title>
...
<body class="black">
	<div id="container-gallery">
		...
		<h2 class="gallery-heading"> PARAPARAUMU LINKS HOME </h2>
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-01.jpg" class="init-hidden" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>
	
			<section class="vertical-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-02.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-03.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-04.jpg" class="picture4 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-05.jpg" class="picture5 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-06.jpg" class="picture4 init-hidden" id="6-slide" rel="up" />
				<p id="7-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-07.jpg" class="picture3 init-hidden" id="7-slide" rel="right" />
				<p id="6-text" class="horizontal-gallery-text init-hidden"></p>
			</section>


			<section class="vertical-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-08.jpg" class="picture3 init-hidden" id="8-slide" rel="up" />
				<p id="8-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/paraparaumu-links/Paraparaumu-Links-Home-09.jpg" class="picture3 init-hidden" id="9-slide" rel="right" />
