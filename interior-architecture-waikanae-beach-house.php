...
<head>
	...
	<meta charset="utf-8" />
	<title>WAIKANAE BEACH HOUSE | Space Architecture</title>
	...
	<div id="container-gallery">
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/waikanae5/kawau1.jpg" class="init-hidden" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>
	
			<section class="vertical-gallery">
				<img src="images/waikanae5/kawau2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae5/kawau3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae5/kawau4.jpg" class="picture4 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae5/kawau5.jpg" class="picture5 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae5/kawau6.jpg" class="picture4 init-hidden" id="6-slide" rel="up" />
				<p id="7-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae5/kawau7.jpg" class="picture3 init-hidden" id="7-slide" rel="right" />
				<p id="6-text" class="horizontal-gallery-text init-hidden"></p>
			</section>


			<section class="vertical-gallery">
				<img src="images/waikanae5/kawau8.jpg" class="picture3 init-hidden" id="8-slide" rel="up" />
				<p id="8-text" class="vertical-gallery-text text-3 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae5/kawau9.jpg" class="picture3 init-hidden" id="9-slide" rel="right" />
				<p id="9-text" class="horizontal-gallery-text init-hidden"></p>
			</section>


			<section class="vertical-gallery">
				<img src="images/waikanae5/kawau10.jpg" class="picture3 init-hidden" id="10-slide" rel="up" />
