	...
	<div id="container-gallery">
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/wetland/wetland1.jpg" class="init-hidden" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>
	
			<section class="vertical-gallery">
				<img src="images/wetland/wetland2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/wetland/wetland3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/wetland/wetland4.jpg" class="picture4 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-4 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/wetland/wetland5.jpg" class="picture3 init-hidden" id="5-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/wetland/wetland6.jpg" class="picture4 init-hidden" id="6-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-4 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/wetland/wetland7.jpg" class="picture3 init-hidden" id="7-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/wetland/wetland8.jpg" class="picture3 init-hidden" id="8-slide" rel="up" />
				<p id="8-text" class="vertical-gallery-text text-4 init-hidden"></p>
			</section>
