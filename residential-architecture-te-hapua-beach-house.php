...
<head>
	<meta charset="utf-8" />	
	<title>COASTAL WETLAND HOME | Space Architecture</title>
...
<body class="black">
	<div id="container-gallery">
		...
		<h2 class="gallery-heading"> COASTAL WETLAND HOME </h2>
		...
		<div id="slider">
			...
			<section class="horizontal-gallery">
				<img src="images/waikanae/tehapua1.jpg" class="" id="1-slide" rel="right"/>
				<p id="1-text" class="horizontal-gallery-text"></p>
			</section>
	
			<section class="vertical-gallery">
				<img src="images/waikanae/tehapua2.jpg" class="picture2 init-hidden" id="2-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae/tehapua3.jpg" class="picture3 init-hidden" id="3-slide" rel="right" />
				<p id="3-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae/tehapua4.jpg" class="picture4 init-hidden" id="4-slide" rel="up" />
				<p id="4-text" class="vertical-gallery-text text-4 init-hidden"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae/tehapua5.jpg" class="picture5 init-hidden" id="5-slide" rel="right" />
				<p id="5-text" class="horizontal-gallery-text text-5 init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae/tehapua6.jpg" class="picture2 init-hidden" id="6-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text text-4 init-hidden" rel="left"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae/tehapua7.jpg" class="picture5 init-hidden" id="7-slide" rel="right" />
				<p id="7-text" class="horizontal-gallery-text text-5 init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae/tehapua8.jpg" class="picture2 init-hidden" id="8-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text text-4 init-hidden" rel="left"></p>
			</section>

			<section class="horizontal-gallery">
				<img src="images/waikanae/tehapua9.jpg" class="picture5 init-hidden" id="9-slide" rel="right" />
				<p id="9-text" class="horizontal-gallery-text init-hidden"></p>
			</section>

			<section class="vertical-gallery">
				<img src="images/waikanae/tehapua10.jpg" class="picture2 init-hidden" id="10-slide" rel="up" />
				<p id="2-text" class="vertical-gallery-text text-4 init-hidden" rel="left"></p>
			</section>
